...
public class AProtoDictionaryShadow<TProtoS,TProto> : Dictionary<UInt32,TProtoS>,IDisposable where TProto:IMessage where TProtoS:IProtoShadowClass<TProto>
{
    ...
    public AProtoDictionaryShadow(RepeatedField<TProto> protoRepeatedField, Func<TProto, IComparable<UInt32>> indexSelector, Action<TProto, UInt32> indexSelectorWrite) : base()
    {
