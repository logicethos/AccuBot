...
public class AProtoDictionary<TProto> : Dictionary<UInt32,TProto>,IDisposable where TProto:IMessage
{
    ...
    public AProtoDictionary(RepeatedField<TProto> protoRepeatedField, Func<TProto, IComparable<UInt32>> indexSelector, Action<TProto, UInt32> indexSelectorWrite) : base()
    {
