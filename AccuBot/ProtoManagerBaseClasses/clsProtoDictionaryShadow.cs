...
public abstract class clsProtoDictionaryShadow<TProtoS,TProto,TProtoList> : IManager<TProto,TProtoList> where TProtoS:IProtoShadowClass<TProto> where TProto:IMessage<TProto> where TProtoList:IMessage<TProtoList>
{
    public AProtoDictionaryShadow<TProtoS,TProto> ManagerList { get; init; }
    ...
    public clsProtoDictionaryShadow(string path,
                    ...
                    Action<TProto, UInt32> indexSelectorWrite)
    {
        ...
        ManagerList = new AProtoDictionaryShadow<TProtoS, TProto>(repeatedfield, indexSelector, indexSelectorWrite);
    ...
    public MsgReply Update(TProto protoClass)
    {
        ...
        ManagerList.TryGetValue((UInt32)IndexSelector(protoClass), out existingNetwork);
