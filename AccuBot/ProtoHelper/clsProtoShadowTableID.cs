...
public class clsProtoShadowTableID<TProtoS,TProto> : Dictionary<UInt32,TProtoS>,IDisposable where TProto:IMessage where TProtoS:IProtoShadowClass<UInt32,TProto>
{
    ...
    public clsProtoShadowTableID(RepeatedField<TProto> protoRepeatedField, Func<TProto, IComparable<UInt32>> indexSelector, Action<TProto, UInt32> indexSelectorWrite) : base()
    {
    ...
    public void Update(TProto newMessage,Action<TProto,TProto>? mapfields = default)
    {
        lock (_lock)
        {
    ...
    public void Add(RepeatedField<TProto> repeatedField)
    {
        lock (_lock)
        {
    ...
    public UInt32 Add(TProto value)
    {
        lock (_lock)
        {
